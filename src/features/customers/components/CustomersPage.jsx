...
import { useCustomersList } from "@/features/customers/queries/customerQueries";
import { useContractsList } from "@/features/contracts/queries/contractQueries";
    ...
    <div className={cn(
      ...
      {showSplitDetail && (
        <div className="flex-1 min-w-0 overflow-y-auto h-full bg-background/30 relative z-10 animate-in slide-in-from-right-8 duration-300">
          ...
          <CustomerDetailPage isSplitView={true} />
          </div>
        </div>
      )}
      ...
      {showDetailOnly && (
        <div className="h-full overflow-y-auto bg-background relative z-10 animate-in slide-in-from-right-8 duration-300">
          <CustomerDetailPage isSplitView={false} />
        </div>
      )}
    </div>
  );
