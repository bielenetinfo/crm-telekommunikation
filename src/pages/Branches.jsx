...
export default function Branches() {
  ...
  return (
    <div className="app-page-shell">
      ...
      >
        {branches.map((b) => (
          <motion.div variants={itemVariants} key={b.id}>
            <Card className="glass-card card-premium transition-all overflow-hidden border-transparent hover:border-primary/20 group relative">
