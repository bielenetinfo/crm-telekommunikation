...
export default function Contracts() {
  ...
  return (
    <div className="space-y-3 px-4 md:px-8 pt-3 md:pt-4 pb-24 w-full text-foreground">
      ...
      <div
        className="glass-card card-premium p-4 rounded-3xl flex flex-col md:flex-row gap-4 items-center justify-between"
      >
        ...
        <Tabs value={statusFilter} onValueChange={setStatusFilter} className="w-full md:w-auto">
          <TabsList className="bg-secondary/50 h-11 p-1 rounded-xl w-full md:w-auto grid grid-cols-3 md:flex">
            <TabsTrigger value="aktiv" className="rounded-lg data-[state=active]:bg-background data-[state=active]:text-foreground text-muted-foreground font-bold text-xs uppercase tracking-widest px-4">Aktiv</TabsTrigger>
            <TabsTrigger value="gekündigt" className="rounded-lg data-[state=active]:bg-background data-[state=active]:text-foreground text-muted-foreground font-bold text-xs uppercase tracking-widest px-4">Gekündigt</TabsTrigger>
            <TabsTrigger value="all" className="rounded-lg data-[state=active]:bg-background data-[state=active]:text-foreground text-muted-foreground font-bold text-xs uppercase tracking-widest px-4">Alle</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
        ...
        <div className="space-y-3">
          {filteredContracts.map(contract => {
            ...
            return (
              <div key={contract.id}>
                <Card
                  className="glass-card card-premium overflow-hidden group hover:bg-secondary/30   cursor-pointer rounded-2xl border-transparent hover:border-primary/20"
