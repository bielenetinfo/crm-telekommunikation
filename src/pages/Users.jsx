  ...
  return (
    <div className="space-y-3 px-4 md:px-8 pt-3 md:pt-4 pb-24 w-full text-foreground">
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-2 gap-3">
        {users.map((u) => (
          <Card key={u.id} className="glass-card card-premium transition-all group border-transparent hover:border-primary/20">
      ...
      <div className="p-6 bg-blue-500/5 rounded-3xl border border-blue-500/20 flex gap-4 mt-8">
